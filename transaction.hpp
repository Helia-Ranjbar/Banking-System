...
class Transaction
{
    string sender_account, reciever_account, cvv2, expire_month , expire_year, pin  ;
                        ...
                        if(enter_pin==pin2)
                        {
                            ...
                            if(is_reciever==true)
                            {
                                ...
                                else
                                {
                                    ...
                                    file<<sender_account<<c<<reciever_account<<c<<amount<<c<<transaction_code<<c<<dt<<c;
                                }
                            }
                        }
